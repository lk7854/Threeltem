	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main mag0">
				<a href="javascript:;" class="logo">Ambitious 广告</a>
				<!-- 显示/隐藏菜单 -->
				<a href="javascript:;" class="seraph hideMenu icon-caidan"></a>
				<!-- 顶级菜单 -->
				<ul class="layui-nav mobileTopLevelMenus" mobile>
					<li class="layui-nav-item" data-menu="contentManagement">
						<a href="javascript:;"><i class="seraph icon-caidan"></i><cite>操作中心</cite></a>
			    ...
			    <ul class="layui-nav top_menu">
					<li class="layui-nav-item" pc>
						<a href="javascript:;" data-url="jsp/infoshow.jsp"><i class="layui-icon" data-icon="&#xe645;">&#xe645;</i><cite>消息通知</cite><span class="layui-badge-dot"></span></a>
					</li>
					<li class="layui-nav-item" pc>
					...
					<li class="layui-nav-item" id="userInfo">
						...
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="LKusers/lookInfo.do"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
		...
		<div class="layui-footer footer">
			<p>@Ambitious 广告——:<a href="http://www.layui.com/" target="_blank">志远广告科技有限公司</a>　　<a onclick="donation()" class="layui-btn layui-btn-radius layui-btn-normal l·ayui-btn-small"><i class="layui-icon">&#xe60c;</i> 打赏一波☞<i class="layui-icon">&#xe65e;</i></a></p>
		</div>
	</div>
