...
<html>
  <head>
    ...
    <title>My JSP 'advertiserConsume.jsp' starting page</title>
		...
		layui.use(['layer','table','form'],function(){
			...
			table.on('tool(table)',function(obj){
				...
				if(clickevent == "detail"){
					window.open("jsp/iframe3.jsp?i_id="+clickdata.i_id);//根据订单编号查询订单的消费信息
				}
			});
			//监听下拉列表
  ...
  <body>
    ...
    <script type="text/html" id="tool">
		<a class="layui-btn layui-btn-radius layui-btn-xs layui-btn-normal" lay-event="detail">查询消费情况</a>
