	...
	<script type="text/javascript">
		...
		layui.use(['layer','table','form'],function(){
			...
			treload = table.render({
				elem:"#tb",
				url:"post/postQuery.do",
				cellMinWidth:true,
				page:true,
				cols:[[
					{field:"p_id",title:"编号",sort:true,width:100,fiexed:"left",align:"center"},
					{field:"p_name",title:"广告名",sort:true,align:"center"},
					{field:"p_addTime",title:"新增时间",sort:true,align:"center"},
					{field:"p_state",title:"状态",sort:true,width:80,align:"center",templet:function(d){
						if(d.p_state==0){return "<i style='color:red'>待审核</i>";}
						if(d.p_state==1){return "<i style='color:black'>未通过</i>";}
						if(d.p_state==2){return "<i style='color:blue'>通过</i>";}
					}},
					{field:"upname",title:"创建/修改人",width:105,align:"center"},
					{field:"p_updateTime",title:"修改时间",sort:true,align:"center"},
  ...
  <body>
		...
		<div class="layui-inline">
			<form class="layui-form" >
				...
				<div class="layui-input-inline" style="width:200px;">
			    	<select id="p_state" lay-filter="selectstate">
			    ...
			    <div class="layui-input-inline">
			    	<input type="text" placeholder="广告名" id="p_name" class="layui-input search_input">
			    </div>
    ...
    <div hidden id="content">
    	<form id="fm" method="post" style="width:100%; margin-top:5px;" lay-filter="fm" class="layui-form">
    		<input hidden id="u_id" name="u_id">
    		<div class="layui-form-item">
			    <label class="layui-form-label">编号</label>
			    <div class="layui-input-block">
			      <input readonly="readonly" style="width:330px;" id="id" name="p_id" required  lay-verify="required" class="layui-input">
			    </div>
			 </div>
    		<div class="layui-form-item">
			    <label class="layui-form-label">广告</label>
			    <div class="layui-input-block" style="width:330px;">
				    <input type="text" id="p_name" name="p_name" style="width:330px;" required  lay-verify="required" class="layui-input">
			    </div>
			 </div>
			 <div class="layui-form-item">
			    <label class="layui-form-label">广告连接</label>
			    <div class="layui-input-block" style="width:330px;">
				    <input type="text" id="p_formPage" name="p_formPage" style="width:330px;" required  lay-verify="required" class="layui-input">
			    </div>
			 </div>
    		<div class="layui-form-item">
			    <label class="layui-form-label">类型</label>
			    <div class="layui-input-block">
			      <input type="text" name="pt_name" style="width:330px;" required  lay-verify="required" class="layui-input">
			    </div>
			</div>
    		<div class="layui-form-item">
			    <label class="layui-form-label">备注</label>
			    <div class="layui-input-block">
			      <input type="text" name="p_remark" style="width:330px;" required  lay-verify="required" class="layui-input">
			    </div>
			</div>
			<input type="text" hidden id="img1" name="p_url">
    	</form>
    	<label class="layui-form-label">预览</label>
    	<div class="layui-btn-group " style="width:70%;text-align: left;">
			<a class="layui-btn" onclick="show1('img1')">广告</a>
		</div>
    </div>   
