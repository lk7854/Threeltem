...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['我知道了'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">欢迎使用Ambitious广告系统(#^.^#)!很荣幸为您服务...</br>须知：在使用本系统前，请仔细阅读后台首页内的《用户手册》，避免使用中遇到一些简单的问题造成困扰。——志远广告</p></pclass></p></div>',
