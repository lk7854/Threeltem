layui.config({
    ...
    $("body").on("click",".img_del",function(){
        var _this = $(this);
        layer.confirm('确定删除图片"'+_this.siblings().find("input").attr("title")+'"吗？',{icon:3, title:'提示信息',offset:'rd'},function(index){
    ...
    $(".batchDel").click(function(){
        ...
        if($checkbox.is(":checked")){
            layer.confirm('确定删除选中的图片？',{icon:3, title:'提示信息',offset:'rd'},function(index){
